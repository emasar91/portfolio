...
const projects: Project[] = [
	{
		...
		thumbnailImage: '/assets/images/modern-finance-app.png',
		gallery: [
			{
	...
	},
	{
		...
		thumbnailImage: '/assets/images/modern-finance-overview.png',
		gallery: [
			{
	...
	},
	{
		...
		thumbnailImage: '/assets/images/modern-apparel-storefront.png',
		gallery: [
